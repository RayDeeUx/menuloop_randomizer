...
bool PlaylistModeWarning::init(bool isCringe) {
	if (!FLAlertLayer::init(nullptr, "Playlist-like Playback Mode Warning",
		fmt::format(
			"{}<cr>This feature is ***very*** unstable. It's best if you restart your game after toggling this setting.</c>\n\n<cy>Known issues (usually for non-Windows users):</c>\n<cy>- Songs may stop changing while/after viewing Geode UI, the Tower, the icon kit, or the shops.</c>\n<cy>- Playlist-like Playback Mode disables loops from the Tower, all shops, and all vaults. (Not much of a loss; those loops get tiring after a while.)</c>\n<cy>- Playlist-like Playback Mode may break when there is only one song for the mod to choose from.",
